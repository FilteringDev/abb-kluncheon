...
[![jsdelivr stat](https://data.jsdelivr.com/v1/package/npm/@filteringdev/abb-kluncheon/badge)](https://www.jsdelivr.com/package/npm/@filteringdev/abb-kluncheon)

abb-kluncheon 유저스크립트는 klauncher.kr에 있는 난독화되어 있는 애드블록 탐지 스크립트를 우회하는 유저스크립트입니다.

abb-kluncheon 유저스크립트는 AdGuard와 애드블록 커뮤니티에 의해 관리되고 있습니다.

설치/이용 과정에서 도움이 필요하시거나 궁금증이 있으시다면 GitHub Discussions를 이용해 주세요.
사용 도중에 해당 유저스크립트가 문제를 발생시킨다고 생각되시면 GitHub Issues를 이용해 주세요.

> [!IMPORTANT]
> abb-kluncheon 유저스크립트 유지보수자는 abb-kluncheon 유저스크립트와 함께 아래 애드블록들 중 하나를 사용하실 것을 권장합니다:
> - AdGuard
> - uBlock Origin
>
...
https://cdn.jsdelivr.net/npm/@filteringdev/abb-kluncheon@latest/dist/abb-kluncheon.user.js
...
- AdGuard for iOS
  ...
  3. Safari에서 [빠른 시작 세션에 있는 URL](https://cdn.jsdelivr.net/npm/@filteringdev/abb-kluncheon@latest/dist/abb-kluncheon.user.js)을 클릭하십시오.
